...
_Serializer: {"": "_MessageTraverser;",
  ...
  visitMap$1: function(map) {
    ...
    return ["map", id, this._serializeList$1($.List_List$from(map.get$keys(), true)), this._serializeList$1($.List_List$from(map.get$values(), true))];
  },
...
["glass_scroll.dart", "glass_scroll.dart", , {
main: function() {
  var t1, t2;
  t1 = {};
  t2 = document;
  ...
  new $._EventStreamSubscription(0, t2._target, t2._eventType, new $.main_closure(), t2._useCapture)._tryResume$0();
  t1.scrollSubscription_0 = null;
  t1.movingScroll_1 = false;
  t1.eventCount_2 = 0;
  t1.slide_3 = 1;
  t2 = new $.main__moveScroll(t1, 555);
  new $.main__registerScroll(t1, t2, new $.main__onDoneScroll(t1, t2)).call$0();
},
...
main__moveScroll: {"": "Closure;box_0,height_1",
  call$1: function(e) {
    var t1, t2, t3;
    t1 = this.box_0;
    $.Primitives_printString("_moveScroll:movingScroll = " + t1.movingScroll_1);
    t1.eventCount_2 = $.$add$ns(t1.eventCount_2, 1);
    if ($.$gt$n(t1.eventCount_2, 25)) {
      t1.movingScroll_1 = true;
      t1.eventCount_2 = 0;
    }
    if (t1.movingScroll_1) {
      t2 = window;
      t3 = t1.slide_3;
      if (typeof t3 !== "number")
        throw $.iae(t3);
      t2.scrollTo(0, this.height_1 * t3);
      t1.slide_3 = $.$add$ns(t1.slide_3, 1);
      t1.movingScroll_1 = false;
      t1.eventCount_2 = 0;
    }
  }
...
main__onDoneScroll: {"": "Closure;box_0,_moveScroll_2",
  call$0: function() {
    var t1, t2, scrollSubscription;
    $.Primitives_printString("_onDoneScroll");
    t1 = this.box_0;
    t1.scrollSubscription_0.cancel$0();
    t1.movingScroll_1 = true;
    t2 = window;
    C.EventStreamProvider_scroll.forTarget$2$useCapture;
    t2 = new $._EventStream(t2, C.EventStreamProvider_scroll._eventType, false);
    scrollSubscription = new $._EventStreamSubscription(0, t2._target, t2._eventType, this._moveScroll_2, t2._useCapture);
    scrollSubscription._tryResume$0();
    t1.scrollSubscription_0 = scrollSubscription;
  }
},

main__registerScroll: {"": "Closure;box_0,_moveScroll_3,_onDoneScroll_4",
  call$0: function() {
    var t1, scrollSubscription;
    $.Primitives_printString("_registerScroll");
    t1 = window;
    C.EventStreamProvider_scroll.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, C.EventStreamProvider_scroll._eventType, false);
    scrollSubscription = new $._EventStreamSubscription(0, t1._target, t1._eventType, this._moveScroll_3, t1._useCapture);
    scrollSubscription._tryResume$0();
    this.box_0.scrollSubscription_0 = scrollSubscription;
  }
}},
1],
]);
...
C.EventStreamProvider_scroll = new $.EventStreamProvider("scroll");
...
// Native classes
$.defineNativeMethods("DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError", $.Interceptor);
...
$.defineNativeMethods("Document|HTMLDocument|Node", $.Node);
...
//# sourceMappingURL=glass_scroll.dart.js.map
//@ sourceMappingURL=glass_scroll.dart.js.map
